...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    const userData = JSON.parse(localStorage.getItem('aptiq_user') || 'null');
    if (!token) {
    ...
    if (dashContainer && userData) {
      dashContainer.style.display = 'block';
      document.getElementById('dashHighScore').textContent = userData.highestScore || '0';
      document.getElementById('dashRecentTest').textContent = userData.recentTest || 'None';
